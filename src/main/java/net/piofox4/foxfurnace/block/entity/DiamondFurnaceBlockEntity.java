...
public class DiamondFurnaceBlockEntity extends AbstractGenericFurnaceBlockEntity {

    public DiamondFurnaceBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlocks.DIAMOND_FURNACE_ENTITY_TYPE, pos, state, RecipeType.SMELTING,Ref.minusTotalCookTimeDiamond);
    }

    public static <T extends BlockEntity> void tick(World world, BlockPos blockPos, BlockState state, T t) {
        AbstractGenericFurnaceBlockEntity.tick(world,blockPos,state,(DiamondFurnaceBlockEntity)t);
    }
    ...
    protected int getCurrentConfigValue() {
        return Ref.minusTotalCookTimeDiamond;
    }
}
