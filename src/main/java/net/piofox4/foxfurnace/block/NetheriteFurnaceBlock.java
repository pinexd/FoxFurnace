...
public class NetheriteFurnaceBlock extends AbstractGenericFurnaceBlock {
    ...
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType options) {
        AbstractGenericFurnaceBlock.appendTooltip(Ref.minusTotalCookTimeNetherite,tooltip);
